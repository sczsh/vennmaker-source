...
public class Compute {
     ...
     * @param Network
     * @param Actors
     * @param allActors : true: for all actors, false: only for actors drawn on the
     *                  network map
     */
     ...
     *
     * @param x      position x in the adjacency matrix
     * @param y      position y in the adjacency matrix
     * @param alter  first actor to check, if it's connected with alter2
     * @param alter2 second actor to check the connection between alter and alter2
     */
     ...
     *
     * @param n the network yet to check
