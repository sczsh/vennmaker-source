...
public class VennMakerCoordinateSystem {
     ...
     * view.
     *
     * @param mid The current mid point in java2d space (usually the current ego's
     *            center)
     */
     ...
     *
     * @param rect A rectangle in vmcs space.
     ...
     *
     * @param pt A point in vmcs space.
     ...
     *
     * @param value A float value in vmcs space.
     ...
     *
     * @param value A float value in java2d space.
     ...
     *
     * @param pt A point in java2d space.
