...
public class RelationMonitor {
     ...
     *
     * @param n das geforderte Netzwerk
     ...
     *
     * @param r die Relation, von der man den Startakteur erfahren moechte
     ...
     *
     * @param r the relation to be added to this vector
     */
     ...
     *
     * @param a the target or sourceactor of the relations (to add all
     *          relations, when this actor is moved)
     * @param n the network of the moved actor
     */
     ...
     *
     * @param a the startactor for the relations
     * @param n the network of the actor
     ...
     *
     * @param a the targetactor to whom all relations are going
     * @param n the network in which these relations are going to this actor
     ...
     *
     * @param a the actor connected to the relations
     * @param n the network in which you are looking for the connected relations
