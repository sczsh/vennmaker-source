...
public class RelationColorVisualizer extends Visualizer {
     ...
     *
     * @param subject the relation, which has a specific attribute
     * @param network the network of the relation
     ...
     *
     * @param colors a map with the attributes as keys and the colors as data
     */
