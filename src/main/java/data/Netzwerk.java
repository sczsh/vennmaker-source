...
public class Netzwerk implements EventLogger {
	...
	*/
     ...
     *
     * @param attributeCollector the attributeCollector to retrieve the relationColorVisualizer
     * @param type               the corresponding attributeType
     ...
     *
     * @param name der Name des neuen Netzwerkes
     ...
     *
     * @param isFinalEvent <code>true</code> wenn das NetzwerkEvent nicht mehr rueckgaengig
     *                     gemacht werden soll
     */
     ...
     * network
     *
     * @param clonedNetwork  the new network which needs the new relations
     * @param event          add all added relations to the complexEvent
     * @param actorsForClone the actors, which are cloned, to loop
     */
     ...
     *
     * @param aType - geaendertes Attribut
     */
    ...
    /**
     * @param metaData - Notizen zu diesem Netzwerk
     */
     ...
     *
     * @param name starting String to derive the new unique name
