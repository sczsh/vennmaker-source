...
public class Akteur implements Serializable, QuestionSubject, AttributeSubject,
     ...
     *
     * @param src Das Netzwerk für das die Eigenschaften gelten.
     * @param dst Das Netzwerk für das die Eigenschaften auch gelten sollen.
     */
     ...
     *
     * @param src Das Netzwerk fuer das die Eigenschaften gelten.
     * @param dst Das Netzwerk fuer das die Eigenschaften auch gelten sollen.
     */
     ...
     *
     * @param src Netzwerk fuer das die Eigenschaften gelten.
     * @param dst Netzwerk fuer das die Eigenschaften gelten sollen.
     */
     ...
     *
     * @param n Das Netzwerk, in dem der Akteur enthalten ist und für das die
     ...
     *
     * @param n     Das entsprechende Netzwerk. Darf nicht <code>null</code> sein.
     * @param point Der entsprechende Punkt. Darf nicht <code>null</code> sein.
     */
    ...
    /**
     * @param actor   the actor, the relation leads to
     ...
     * @param network the network in which the <code>Relation</code> should be
     *                searched
     * @param type    the given <code>AttributeType</code> of the
     *                <code>Relation</code>
     ...
     * @param value   the new value for the given type in the given network
     */
     ...
     *
     * @param type the attributetype, of which the value needs to be removed
     * @param net  the specific network, where the attribute has to be removed
     */
