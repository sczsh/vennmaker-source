...
public class Question {
    ...
    /**
     * @param predefinedAnswers the predefinedAnswers to set
     */
    ...
    /**
     * @param allowMultipleSelection the allowMultipleSelection to set
     */
    ...
    /**
     * @param offerNoAnswer the offerNoAnswer to set
     */
    ...
    /**
     * @param offerUnknown the offerUnknown to set
     */
    ...
    /**
     * @param freeForm the freeForm to set
     */
    ...
    /**
     * @param numericalMinValue the numericalMinValue to set
     */
    ...
    /**
     * @param numericalMaxValue the numericalMaxValue to set
     */
    ...
    /**
     * @param numericalUnit the numericalUnit to set
     */
    ...
    /**
     * @param visualMappingMethod the visualMappingMethod to set
     */
    ...
    /**
     * @param visualMapping the visualMapping to set
     */
