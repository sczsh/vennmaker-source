...
public class TemplateBackgroundOperations extends Thread {
     ...
     *
     * @param templateFile file to save or load
     * @param parent       parent component to show notification dialogs
     * @param withEvents   <code>true</code> if <code>LoadTemplateEvent</code> should be
     *                     fired (used for loading a template an immediately starting the
     *                     <code>InterviewController</code>
     * @param op           <code>TemplateOperation</code> for this object.
