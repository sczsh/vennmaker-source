...
public class EventProcessor {
     ...
     *
     * @param listener Ein Listener, der Events ablehnen und genehmigen kann.
     */
     ...
     *
     * @param listener Ein gültiger Listener.
     */
    ...
    /**
     * @param event    Event wie oben
     * @param newEvent zeigt an, ob das Event neu ist (beispiel für alte Events: nach
     *                 redo-wunsch, da dieses event nur erneut durchgejagt wird).
     * @param dispatch zeigt an, für welches Netzwerk dieses Ereignis bestimmt sein
