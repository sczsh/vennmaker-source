...
public class BackgroundInfo implements Cloneable, Serializable {
    ...
    /**
     * @param numCircles the numCircles to set
     */
    ...
    /**
     * @param numSectors the numSectors to set
     */
     ...
     * falsch ist.
     *
     * @param index Ein gültiger Index (&gt;= 0 und &lt; NUMSECTORS)
    ...
    /**
     * @param filenameOfSelection the filename of the Image Part which is Selected
     */
    ...
    /**
     * @param imgoption the imgoption to set
     */
    ...
    /**
     * @param circlesAsc the circlesAsc to set
     */
    ...
    public Point2D getRandomPointBySectorAndCircle(Akteur akteur,
        ...
        if (sectorAttribute != null || circleAttribute != null) {
            ...
            if (akteurSectorValue != null) {
                ...
                for (int i = 0; i < numSectors; ++i) {
                    SectorInfo si;
                    if ((si = this.sektoren.get(i)).label.equals(akteurSectorValue)) { // found label matching value
...
//						System.out.println();
            ...
            if (akteurCircleValue != null) {
                ...
                for (int i = 0; i < numCircles; ++i) {
                    ...
                    if ((this.circles.get(i)).equals(akteurCircleValue)) { // found label matching value
