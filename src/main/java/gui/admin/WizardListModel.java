...
public class WizardListModel implements ListModel {
     ...
     *
     * @param index An index such that <code>0 &lt;= index &lt; size()</code>
     * @param name  A name for the wizard
     * @param wiz   The wizard itself.
     * @throws java.lang.IllegalArgumentException If a wizard with the specified name already exists!
     */
     ...
     *
     * @param index The index which position is to be removed
     */
     ...
     *
     * @param index  The position in the list for the wizard
     * @param name   The name for the wizard
     * @param wizard The wizard itself.
     */
     ...
     * @param index2 Another valid index
     */
