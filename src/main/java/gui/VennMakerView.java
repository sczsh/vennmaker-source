...
public class VennMakerView extends JComponent implements Printable,
     ...
     *
     * @param netzwerk Das Modell fuer die Zeichenflaeche.
     */
     ...
     *
     * @param x x-coordinate in java2d space
     * @param y y-coordinate in java2d space
     */
     ...
     *
     * @param start The destination of the relation. No relation will be displayed
     *              if start is <code>null</code>.
     * @param x     The current end point (x-coordinate) in java2d space.
     * @param y     The current end point (y-coordinate) in java2d space.
     */
     ...
     *
     * @param actor The dragged actors or <code>null</code> after a interactive move
     ...
     *
     * @param newImg - the new background image
     */
     ...
     * @param imgType  - "PNG" or "JPG"
     * @param width    - destinated width
     * @param height   - destinated height
     * @throws IOException
     */
     ...
     *
     * @param g         - graphics which should be printed
     * @param pf        - format options
     * @param pageIndex - (only 0 supported atm)
     */
     ...
     *
     * @param end    Das Objekt auf das die Linie zeigen soll.
     * @param startX X-Koordinate: Der Punkt auf der Linie (um richtung zu berechnen)
     * @param startY Y-Koordinate: Der Punkt auf der Linie (um richtung zu berechnen)
    ...
    public void paintComponent(final Graphics graphics) {
        ...
        for (final Akteur akteur : this.netzwerk.getAkteure()) { // Filter aktiviert?
            float a = 1f;
...
*/
     ...
     *
     * @param anzahl   the number of circles
     ...
     *
     * @param graphics The view graphics context
     */
     ...
     *
     * @param actor the actor that is to be placed
     * @param x2    x-coordinate
     * @param y2    y-coordinate
     ...
     *
     * @param ce     - ComplexEvent
     * @param a      - Akteur fÃ¼r den die Events gelten sollen
     * @param x_mid  - X Position des Zentrums (beim Verschieben vorrausberechnen
     *               !!!)
     * @param y_mid  - Y Position des Zentrums (beim Verschieben vorrausberechnen
     *               !!!)
     * @param actorX - X Position des Akteurs (beim Verschieben vorrausberechnen !!!)
     * @param actorY - Y Position des Akteurs (beim Verschieben vorrausberechnen !!!)
     ...
     * circles.
     *
     * @param x_m - x coordinate of the center (x of EGO)
     * @param y_m - y coordinate of the center (y of EGO)
     * @param x   - x coordinate of the destinated position
     * @param y   - y coordinate of the destinated position
     ...
     * @param offset   -1 - left 0 - center 1 - right
     */
     ...
     * @param akteur        - actor under cursor
     */
     ...
     *
     * @param mousePosition - current cursor position
     * @param relation      - relation under cursor
     */
