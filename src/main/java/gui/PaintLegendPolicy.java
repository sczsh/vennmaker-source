...
public class PaintLegendPolicy implements Serializable {
     ...
     *
     * @param paintDashing   <code>true</code> if the dashing legend should be painted,
     *                       <code>false</code> if not
     * @param paintThickness <code>true</code> if the thickness legend should be painted,
     *                       <code>false</code> if not
     * @param paintColor     <code>true</code> if the color legend should be painted,
     *                       <code>false</code> if not
     */
