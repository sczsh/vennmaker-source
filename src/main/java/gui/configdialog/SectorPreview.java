...
public class SectorPreview extends JPanel {
     ...
     *
     * @param backgroundinfo information about circles and sectors
     */
     ...
     *
     * @param sector sector which will be the new active sector
     */
     ...
     *
     * @param i index of current touchpoint in array
     */
    ...
    /**
     * @param touchPointIndex mouseOnTouchPoint
     * @param x
     * @param y
     */
