...
public class ActorImageSaveElement extends SaveElement {
     ...
     *
     * @param iconsToDelete an <code>Array</code> of Icons which should be deleted
     */
     ...
     *
     * @param aType the selected <code>AttributeType</code>
     */
     ...
     *
     * @param indicies the selected indicies for the current selected
     *                 <code>AttributeType</code>
     */
     ...
     *
     * @param iconNames the names of new added icons
     */
     ...
     *
     * @param imageData the base64 encoded added images
     */
