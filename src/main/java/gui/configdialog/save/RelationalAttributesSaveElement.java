...
public class RelationalAttributesSaveElement extends SaveElement {
     ...
     *
     * @param relationTypes     Holds the attribute types of the relations
     * @param directedRelations a <code>Map</code> containing if a relation is directed or not
     */
     ...
     *
     * @param relationTypes a <code>Vector</code> with the attribute types
     */
