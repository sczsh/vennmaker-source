...
public class DrawLineLabel {
    ...
    /**
     * @param lineStart - Point where the line starts
     * @param lineEnd   - Point where the line ends
     ...
     *
     * @param g2d     - Graphics to draw on
     * @param yOffset - Offset to add to Box/Text Position (needed if multiple labels
