...
public class ExportCSV implements ExportData {
    ...
    /**
     * @param network the network, these statistics describe
        ...
        for (final Akteur alter : VennMaker.getInstance().getProject()
            ...
            if ((network.getAkteure().contains(alter))) {
                ...
                for (final Akteur alter2 : VennMaker.getInstance().getProject()
                    ...
                    } else if ((alter != alter2) && ((r != null) || (r2 != null))
                            && (directed == false)) {
                        if (r != null) {
     ...
     * @param textelement the source text string
     * @param format      comma or semicolon: Defines the numeric print output format.
