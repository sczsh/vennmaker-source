...
public class CsvOutput {
     ...
     *
     * @param elementlist Input: String or Number (int, double)
     * @param separator   Defines the delimiter symbol (e.g. , or ; ...)
     * @param textelement Defines the identification character for text elements
     * @param format      Defines the numeric print output format. (e.g. comma or point:
     *                    1,3 or 1.3)
