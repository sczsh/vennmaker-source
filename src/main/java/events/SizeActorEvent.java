...
public class SizeActorEvent extends ActorInNetworkEvent {
     ...
     *
     * @param akteur     Der Akteur, der verändert wurde.
     * @param netz       Das Netzwerk, in dem gearbeitet wurde.
     * @param sizeChange Die Größenänderung des Akteurs (in Prozent der vorgängergröße).
