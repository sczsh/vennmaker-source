...
public class InterviewLayer implements Serializable {
     ...
     *
     * @param element InterviewElement
     */
     ...
     *
     * @param elem <code>InterviewElement</code> to get the index of
     ...
     *
     * @param elem element to get root from
     * @return root of elem
     */
     ...
     *
     * @param elem InterviewElement to check
     ...
     *
     * @param elem InterviewElement to register
     */
     ...
     *
     * @param interviewTree interview tree from CDInterviewCreator
     */
     ...
     *
     * @param index index for value to set
     ...
     *
     * @param elementToReplace the new <code>InterviewElement</code>
