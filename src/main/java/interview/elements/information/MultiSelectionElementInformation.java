...
public class MultiSelectionElementInformation extends InputElementInformation {
     ...
     * @param attributeTypeOrder     the attribute order the user has definied
     */
     ...
     * <code>AlteriMultiAttributeOneActorElement</code>
     *
     * @param attributeTypeOrder the attribute order, the user has defined by drag&drop in the
     *                           configuration dialog of the
     *                           <code>AlteriMultiAttributeOneActorElement</code>
     */
