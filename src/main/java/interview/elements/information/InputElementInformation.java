...
public class InputElementInformation extends InterviewElementInformation {
    ...
    /**
     * Returns the network f�r the <code>StandardElement</code>
     *
     * @return the network f�r the <code>StandardElement</code>
     */
    ...
    /**
     * Sets the network f�r the <code>StandardElement</code>
     *
     * @param network the network f�r the <code>StandardElement</code>
     */
