...
public abstract class InterviewElement implements Serializable, Transferable,
     ...
     *
     * @param actors - actors of this element
     */
     ...
     *
     * @param n value of the internal pointer
     */
     ...
     *
     * @param elem InterviewElement to add as child
     ...
     *
     * @param elem  InterviewElement to add
     * @param index Position to add elem
     * @throws IllegalArgumentException
     */
     ...
     *
     * @param parent parent InterviewElement
     */
     ...
     *
     * @param isChild true if InterviewElement is child, false if not
     */
     ...
     *
     * @param description name of this element
     */
    ...
    /**
     * @param elementNameInTree the elementNameInTree to set
     */
     ...
     *
     * @param fSelector the current filter selector for this InterviewElement
     */
     ...
     *
     * @param filter the current Filter of this InterviewElement in the
     *               FilterSelector
     */
     ...
     *
     * @param filterIndex the selected Filter indicies of the FilterSelector
     */
     ...
     *
     * @param information Information to recreate this InterviewElement
     */
