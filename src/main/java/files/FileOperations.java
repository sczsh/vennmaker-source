...
public class FileOperations {
     ...
     *
     * @param rootPath defines the root for these subfolders
     */
     ...
     *
     * @param dir der ordner, der geloescht werden soll
     * @return erfolg?
     */
     ...
     *
     * @param folder new foldername - replaces the old rootfolder
     */
     ...
     *
     * @param filename in wrong format
     ...
     *
     * @param source -> the source directory wich will be zipped
     * @param dest   -> the destination directory the *.vmp file will be saved
     */
     ...
     * VennMaker rootpath
     *
     * @param relativePath the relative path pointing to a resource needed by VennMaker
     ...
     *
     * @param vmpFile   the vmp file to load
     * @param vennFile  the venn file inside the vmp file to load
     * @param directory the last visited directory, if <code>null</code> the home
