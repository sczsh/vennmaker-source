...
public class ImageOperations {
     ...
     * Load an image file
     *
     * @param filename           : svg, png or jpg format
     * @param groesse
     * @param imageScalingFactor (Default: 1.0)
     * @return image
     */
     ...
     * TYPE_INT_ARGB
     *
     * @param src     (BufferedImage containing PNG)
     ...
     *
     * @param selection      (Rectangle to get another Scale of)
     * @param width
     * @param height
     * @param originalWidth
    ...
    /**
     * @param imgSelection - Rectangle with the upscaled Image Selection
     ...
     *
     * @param imageFile the path to the imagefile to load
     * @return
     */
